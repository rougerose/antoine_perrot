$(document).ready(function () {
	 ...
	 **/
	$("a.icone-lien")
		.append('<span class="icone-loupe"></span>')
		.children("span")
		.css({ opacity: 0 });
	$("a.icone-lien").hover(
		function () {
	...
	$("#slider").each(function () {
		...
		if (pages > 1) {
			scroll
				.before(
					'<span id="sbg" class="scrollBouton gauche">&nbsp;</span>'
				)
				.after(
					'<span id="sbd" class="scrollBouton droite">&nbsp;</span>'
				);
		} else {
			scroll
				.before(
					'<span id="sbg" class="scrollBouton gauche off">&nbsp;</span>'
				)
				.after(
					'<span id="sbd" class="scrollBouton droite off">&nbsp;</span>'
				);
		}
